		...
		<div class="row" align="center" style="background-color: #f5f5f5;">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="panel panel-default text-center">
						<div class="panel-heading">
							<h3 class="panel-title">Historia Clínica <br>Medicación Alto Costo</h3>
						</div>
						<ul class="list-group">
				...
				<div class="col-md-4">
					<div class="panel panel-default text-center">
						<div class="panel-heading">
							<h3 class="panel-title">Resumen de Historia<br> Clínica Artritis</h3>
						</div>
						<ul class="list-group">
				...
				<div class="col-md-4">
					<div class="panel panel-default text-center">
						<div class="panel-heading">
							<h3 class="panel-title">Resumen de Historia Clínica<br> Específica para Hepatitis B y C Crónicas</h3>
						</div>
						<ul class="list-group">
