			...
			<div class="row" style="margin: 10px">
				...
				<div class="col-md-3">
					<div class="panel panel-default text-center">
						...
						<ul class="list-group">
							<li class="list-group-item"><a href="files/formularios/historias/HISTORIA CLINICA DE ARTRITIS PSORIASICA.pdf" target="_blank" class="btn btn-primary">Descargar</a></li>
						</ul>
					</div>
				</div>
