				...
				<table class="tablesorter" id="empresas">
					...
					while ($row=mysql_fetch_array($result)) { ?>
						<tr>
							...
							<td align="center"><a target="_blank" href="empresas.sabana.nueva.php?nrcuit=<?php echo $row['nrcuit'] ?>"><i style="font-size: 20px"  class="glyphicon glyphicon-list-alt"></i></a></td>
						</tr>
					<?php } ?>
					</tbody>
				</table>
