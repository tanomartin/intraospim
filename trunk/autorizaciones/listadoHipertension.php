...
<table width="1020" border="0">
  ...
  <tr>
    ...
    <td scope="row"><div align="left">
      <p class="Estilo3">Programa de Prevenci&oacute;n de Hipertensi&oacute;n Arterial</p>
    </div></td>
...
while ($row = mysql_fetch_array($result)) {
	...
	print ("<td width=93><div align=center><font face=Verdana size=1><a href=javascript:void(window.open('modificaHipertension.php?nrosolicitud=".$row['id']."'))>".$row['id']."</font></div></td>");
