...
if($delcod != 0 and $delcod != NULL) {
	if(isset($_POST)) {
		...
		try {
			...
			$sqlCarga = "INSERT INTO maternoinfantil (delcod,profesional,fechaatencion,nrcuil,nrafil,codpar,nombre,ddntelefono,nrotelefono,edad,talla,peso,perimetrocefalico,estudiofei,otoemisionesacusticas,fondodeojo,ecocadera,controlnro,vacunasaldia,vacunasfaltantes,lactanciamaterna,diagnostico,subdiagnostico,observaciones) VALUES (:delcod,:profesional,:fechaatencion,:nrcuil,:nrafil,:codpar,:nombre,:ddntelefono,:nrotelefono,:edad,:talla,:peso,:perimetrocefalico,:estudiofei,:otoemisionesacusticas,:fondodeojo,:ecocadera,:controlnro,:vacunasaldia,:vacunasfaltantes,:lactanciamaterna,:diagnostico,:subdiagnostico,:observaciones)";
