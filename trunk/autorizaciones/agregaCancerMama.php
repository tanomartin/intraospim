...
<table width="978" border="0">
  <tr>
    ...
    <td colspan="2" scope="row"><div align="left">
      <p class="Estilo3">Nuevo Registro Detecci&oacute;n C&aacute;ncer de Mama</p>
    </div>
      </td>
    <td width="421"><div align="right">
        <input type="button" name="volver" value="Volver a Programa de Detección Precoz del Cáncer de Mama" onclick="location.href='listadoCancerMama.php'"/>
      </div>
    </td>
  </tr>
</table>
<table width="979" border="0">
  <tr>
    ...
    <td width="463" valign="top"><p><span class="Estilo4">Informaci&oacute;n del Beneficiario </span></p>
	  ...
	  <p><strong>Antecedentes CCa Mama : </strong>
	  ...
	  <p><strong>Examen Mamario  : </strong>
          <select name="examenmamario" id="examenmamario">
            <option title="Seleccione un valor" value="">Seleccione un valor</option>
            <option title="Si" value="1">Si</option>
            <option title="No" value="0">No</option>
          </select>
      </p>
	  <p><strong>Fecha &Uacute;ltimo Examen Mamario :</strong>
          <input name="ultimoexamenmamario" type="text" id="ultimoexamenmamario" value="" size="12"/>
      </p>
	  <p><strong>Mamograf&iacute;a  : </strong>
          <select name="mamografia" id="mamografia">
            <option title="Seleccione un valor" value="">Seleccione un valor</option>
            <option title="Si" value="1">Si</option>
            <option title="No" value="0">No</option>
          </select>
      </p>
	  <p><strong>Fecha &Uacute;ltima Mamograf&iacute;a :</strong>
          <input name="ultimamamografia" type="text" id="ultimamamografia" value="" size="12"/>
      </p>
