...
<table class="tablesorter" id="listado">
	...
	?>
		<tr align="center">
			<td><a id="editaRegistro" title="Click para Editar el Registro" class="style_boton5" href='modificaCancerMama.php?nrosolicitud=<?php echo $row['id']; ?>'><?php echo $row['id']; ?></a></td>
