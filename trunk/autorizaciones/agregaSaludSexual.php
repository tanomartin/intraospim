...
function validar(formulario) {
	...
	if (formulario.informacion.options[formulario.informacion.selectedIndex].value == "") {
		alert("Debe seleccionar si se le brinda o no Informacion");
	...
	if (formulario.observaciones.value == "") {
		alert("Debe ingresar un valor en el campo Observaciones");
...
<table width="978" border="0">
  <tr>
    ...
    <td colspan="2" scope="row"><div align="left">
      <p class="Estilo3">Nuevo Registro de Salud Sexual y Procreaci&oacute;n Responsable</p>
    </div>
      </td>
    <td width="421"><div align="right">
        <input type="button" name="volver" value="Volver a Programa de Salud Sexual y Procreaciónn Responsable" onclick="location.href='listadoSaludSexual.php'"/>
      </div>
    </td>
  </tr>
</table>
<table width="979" border="0">
  <tr>
    ...
    <td width="463" valign="top"><p><span class="Estilo4">Informaci&oacute;n del Beneficiario </span></p>
	  ...
	  <p><strong>Se le Brinda Informaci&oacute;n?: </strong>
	  ...
	  <p><strong>Entrega de Preservativos?: </strong>
          <select name="preservativos" id="preservativos">
            <option title="Seleccione un valor" value="">Seleccione un valor</option>
            <option title="Si" value="1">Si</option>
            <option title="No" value="0">No</option>
          </select>
	  ...
	  <p><strong>DIU: </strong>
          <select name="diu" id="diu">
            <option title="Seleccione un valor" value="">Seleccione un valor</option>
            <option title="Si" value="1">Si</option>
            <option title="No" value="0">No</option>
          </select>
      </p>
	  <p><strong>Entrega de Anticonceptivos?: </strong>
          <select name="anticonceptivos" id="anticonceptivos">
            <option title="Seleccione un valor" value="">Seleccione un valor</option>
            <option title="Si" value="1">Si</option>
            <option title="No" value="0">No</option>
          </select>
