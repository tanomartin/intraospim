				 	...
				 	$des = "JUICI.";
							...
							if($row2!=null) {
								$des = "ACUER.";
										...
										$result9 = mysql_db_query("uv0471_intranet",$sql9,$db); 
...
<?
for ($i=1;$i<13;$i++){
	$descri = estado($delcod,$empcod,$año,$i);
	if ($descri == "PAGO") {
...
<table width="1027" border="0">
  <tr>
    <th width="502" scope="row"><div align="left"></div></th>
  ...
  <tr>
    ...
    <td><div align="left">
      <div align="left"><span class="Estilo7">*PAGO = PERIODO PAGO CON DDJJ </span></div>
    </div></td>
  </tr>
  <tr>
  ...
  <tr>
    <th scope="row"><div align="left">
      <div align="left"><span class="Estilo5">*JUICI.= PERIODO EN JUICIO </span></div>
    </div></th>
    <td>&nbsp;</td>
  </tr>
</table>
