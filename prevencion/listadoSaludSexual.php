...
$sql = "SELECT * FROM saludsexual WHERE delcod = $delcod ORDER BY id DESC";
...
<title>Programa de Salud Sexual y Procreaci&oacute;n Responsable</title>
...
<table width="1020" border="0">
  <tr>
    ...
    <td width="660" scope="row"><div align="left">
      <p class="style_titulo">Programa de Salud Sexual y Procreaci&oacute;n Responsable</p>
    </div></td>
...
<form id="listadoSaludSexual" name="listadoSaludSexual" method="post" action="agregaSaludSexual.php">
<table width="1020" border="0">
    <tr>
...
<table class="tablesorter" id="listado">
	...
	?>
		<tr align="center">
			<td><a id="editaRegistro" title="Click para Editar el Registro" class="style_botoneditar chico azul redondo" href='modificaSaludSexual.php?id=<?php echo $row['id']; ?>'><?php echo $row['id']; ?></a></td>
