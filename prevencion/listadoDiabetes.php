...
<table width="1020" border="0">
  <tr>
    ...
    <td width="660" scope="row"><div align="left">
      <p class="style_titulo">Programa de Prevenci&oacute;n de Diabetes</p>
    </div></td>
...
<table class="tablesorter" id="listado">
	...
	?>
		<tr align="center">
			<td><a id="editaRegistro" title="Click para Editar el Registro" class="style_botoneditar chico azul redondo" href='modificaDiabetes.php?id=<?php echo $row['id']; ?>'><?php echo $row['id']; ?></a></td>
