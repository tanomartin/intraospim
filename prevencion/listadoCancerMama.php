	...
	<div class="container">
		<div class="row" align="center" style="background-color: #f5f5f5;">
			...
			<div class="col-md-10 col-md-offset-1">
				<div>
					<input style="float: left;" type="button" name="nuevoregistro" id="nuevoregistro" onclick="location.href='agregaCancerMama.php'" class="style_boton4 nover" value="Nuevo Registro" />
