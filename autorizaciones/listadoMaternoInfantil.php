...
$sql = "SELECT * FROM maternoinfantil WHERE delcod = $delcod ORDER BY id DESC";
...
<table width="1020" border="0">
  <tr>
    ...
    <td width="660" scope="row"><div align="left">
      <p class="style_titulo">Plan Materno Infantil</p>
    </div></td>
...
<form id="listadoMaternoInfantil" name="listadoMaternoInfantil" method="post" action="agregaMaternoInfantil.php">
<table width="1020" border="0">
    <tr>
...
<table class="tablesorter" id="listado">
	...
	?>
		<tr align="center">
			<td><a id="editaRegistro" title="Click para Editar el Registro" class="style_botoneditar chico azul redondo" href='modificaMaternoInfantil.php?id=<?php echo $row['id']; ?>'><?php echo $row['id']; ?></a></td>
