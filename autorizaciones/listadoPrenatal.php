...
<title>Programa de Control Prenatal</title>
<style type="text/css">
<!--
.Estilo3 {
	font-family: Papyrus;
...
<table width="1020" border="0">
  ...
  <tr>
    ...
    <td scope="row"><div align="left">
      <p class="Estilo3">Programa de Control Prenatal</p>
    </div></td>
...
<form id="listadoPrenatal" name="listadoPrenatal" method="post" action="agregaPrenatal.php">
<table width="1020" border="0">
    <tr>
...
$sql = "SELECT * FROM prenatal WHERE delcod = $delcod ORDER BY id DESC";
...
while ($row = mysql_fetch_array($result)) {
	...
	print ("<td width=93><div align=center><font face=Verdana size=1><a href=javascript:void(window.open('modificaPrenatal.php?nrosolicitud=".$row['id']."'))>".$row['id']."</font></div></td>");
