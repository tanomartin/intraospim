...
$(document).ready(function(){
	...
	$("#antecedenteshipertension").change(function(){
		...
		if(antecedentesh=="0") {
			...
			$("#personaantecedenthipertensione option[value='']").prop('selected',true);
...
function validar(formulario) {
	...
	if (formulario.antecedenteshipertension.options[formulario.antecedenteshipertension.selectedIndex].value == "") {
		alert("Debe seleccionar si posee o no Antecedentes de Hipertension");
		document.getElementById("antecedenteshipertension").focus();
		return false;
	}
	if (formulario.antecedenteshipertension.options[formulario.antecedenteshipertension.selectedIndex].value == "1") {
		if (formulario.personaantecedentehipertension.options[formulario.personaantecedentehipertension.selectedIndex].value == "") {
			alert("Debe ingresar el Familiar que presenta Antecedentes de Hipertension");
			document.getElementById("personaantecedentehipertension").focus();
			return false;
		}
	}
	if (formulario.antecedentescardiacos.options[formulario.antecedentescardiacos.selectedIndex].value == "") {
		alert("Debe seleccionar si posee o no Antecedentes Cardiacos");
		document.getElementById("antecedentescardiacos").focus();
		return false;
	}
	if (formulario.antecedentescardiacos.options[formulario.antecedentescardiacos.selectedIndex].value == "1") {
		if (formulario.personaantecedentecardiaco.options[formulario.personaantecedentecardiaco.selectedIndex].value == "") {
			alert("Debe ingresar el Familiar que presenta Antecedentes Cardiacos");
			document.getElementById("personaantecedentecardiaco").focus();
			return false;
		}
	}
...
<table width="978" border="0">
  <tr>
    ...
    <td colspan="2" scope="row"><div align="left">
      <p class="Estilo3">Nuevo Registro Prevenci&oacute;n de Hipertensi&oacute;n Arterial</p>
    </div>
      </td>
    <td width="421"><div align="right">
        <input type="button" name="volver" value="Volver a Programa de Prevención de Hipertensión Arterial" onclick="location.href='listadoHipertension.php'"/>
      </div>
    </td>
  </tr>
</table>
<table width="979" border="0">
  <tr>
    ...
    <td width="463" valign="top"><p><span class="Estilo4">Informaci&oacute;n del Beneficiario </span></p>
	  ...
	  <p><strong>Antecedentes Hipertensi&oacute;n: </strong>
          <select name="antecedenteshipertension" id="antecedenteshipertension">
            <option title="Seleccione un valor" value="">Seleccione un valor</option>
            <option title="Si" value="1">Si</option>
            <option title="No" value="0">No</option>
          </select>
      </p>
	  <p><strong>Familiar con Antecedente Hipertensi&oacute;n: </strong>
          <select name="personaantecedentehipertension" id="personaantecedentehipertension">
            <option title="Seleccione un valor" value="">Seleccione un valor</option>
	  ...
	  <p><strong>Antecedentes Card&iacute;acos: </strong>
          <select name="antecedentescardiacos" id="antecedentescardiacos">
            <option title="Seleccione un valor" value="">Seleccione un valor</option>
            <option title="Si" value="1">Si</option>
            <option title="No" value="0">No</option>
          </select>
      </p>
	  <p><strong>Familiar con Antecedente Card&iacute;aco: </strong>
          <select name="personaantecedentecardiaco" id="personaantecedentecardiaco">
            <option title="Seleccione un valor" value="">Seleccione un valor</option>
            <option title="Abuelos" value="1">Abuelos</option>
            <option title="Padres" value="2">Padres</option>
            <option title="T&iacute;os" value="3">T&iacute;os</option>
