...
$sql = "SELECT * FROM hipertension WHERE delcod = $delcod ORDER BY id DESC";
...
<title>Programa de Prevenci&oacute;n de Hipertensi&oacute;n Arterial</title>
...
<table width="1020" border="0">
  <tr>
    ...
    <td width="660" scope="row"><div align="left">
      <p class="style_titulo">Programa de Prevenci&oacute;n de Hipertensi&oacute;n Arterial</p>
    </div></td>
...
<form id="listadoHipertension" name="listadoHipertension" method="post" action="agregaHipertension.php">
<table width="1020" border="0">
    <tr>
...
<table class="tablesorter" id="listado">
	...
	?>
		<tr align="center">
			<td><a id="editaRegistro" title="Click para Editar el Registro" class="style_botoneditar chico azul redondo" href='modificaHipertension.php?id=<?php echo $row['id']; ?>'><?php echo $row['id']; ?></a></td>
