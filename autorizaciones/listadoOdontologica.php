...
<title>Programa de Prevenci&oacute;n Odontol&oacute;gica</title>
...
<table width="1020" border="0">
  <tr>
    ...
    <td width="660" scope="row"><div align="left">
      <p class="style_titulo">Programa de Prevenci&oacute;n Odontol&oacute;gica</p>
    </div></td>
...
<form id="listadoOdontologica" name="listadoOdontologica" method="post" action="agregaOdontologica.php">
<table width="1020" border="0">
    <tr>
...
<table class="tablesorter" id="listado">
	...
	?>
		<tr align="center">
			<td><a id="editaRegistro" title="Click para Editar el Registro" class="style_botoneditar chico azul redondo" href='modificaOdontologica.php?id=<?php echo $row['id']; ?>'><?php echo $row['id']; ?></a></td>
