	...
	<div class="container">
		<div class="row" align="center" style="background-color: #f5f5f5;">
			...
			<?php if ($_SESSION['delcod'] != '2602') { ?>
					<input style="float: left" class="btn btn-primary" type="button" value="Nueva Órden" onclick="location.href='listado.nueva.php'" />	
			<?php } else { ?>
					<input style="float: left" class="btn btn-primary" type="button" value="Importar Órdenes" onclick="location.href='listado.importar.php'"/>	
			<?php } ?>
					<input style="float: right" class="btn btn-primary" type="button" value="Listado Completo Órdenes" onclick="location.href='listado.completo.php'" />	
				</div>
			</div>
			<div class="col-md-10 col-md-offset-1">
			    <h3>Ordenes de Consulta Realizadas en el mes</h3>
				<form>
